...
class ManageSurvey {
    ...
    public function displaySurveyForm($id = null, $stitle = '', $start_date = '', $end_date = '', $description = '') {
...
// Example usage:
$manageSurvey = new ManageSurvey($conn);
$manageSurvey->displaySurveyForm();
?>
